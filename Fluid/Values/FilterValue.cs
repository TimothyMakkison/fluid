...
{
    public sealed class FilterValue : FluidValue
    {
        ...
        public FilterValue(Func<FunctionArguments, TemplateContext, ValueTask<FluidValue>> asyncAction)
        {
            _action = asyncAction;
        }

        public FilterValue(Func<FunctionArguments, TemplateContext, FluidValue> action)
        {
