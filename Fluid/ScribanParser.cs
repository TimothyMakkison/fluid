...
namespace Fluid
{
    public class ScribanParser : IParser
    {
        ...
        public ScribanParser(FluidParserOptions parserOptions)
        {
            ...
            Array.Parser = LBracketSkip.SkipAnd(Separated(Comma, FilterExpression)).AndSkip(RBracket).Then<Expression>((_,x) => new ArrayLiteralExpression(x));
        ...
        /// </summary>
        public virtual IParser Compile()
        {
